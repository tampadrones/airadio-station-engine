...
def build_music_caption_formula(
    *,
    ...
    topic = _primary_topic(profile, mood)
    ...
    setting = f"{daypart} city-radio atmosphere"
    ...
    return (
        ...
        f"{texture}, {topic} theme, {setting}, {hook}, {rhythm}"
    )
...
def build_song_concept_prompt(*, music_caption: str, technical_parameters: dict[str, str], lyrics: str | None = None) -> str:
    return (
        "1) MUSIC CAPTION:\n"
        f"{music_caption}\n\n"
...
def build_negative_prompt(*, genre: str, station_profile: dict | None = None) -> str:
    ...
    return f"avoid obvious loops; {exclusion}; {lyric_constraint}; avoid clipping and silence"
