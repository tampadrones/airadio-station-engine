...
class Settings(BaseSettings):
    ...
    lyrics_refiner_base_urls: str = Field(default="http://10.0.0.5", alias="LYRICS_REFINER_BASE_URLS")
    lyrics_refiner_model: str = Field(default="qwen2.5", alias="LYRICS_REFINER_MODEL")
    lyrics_refiner_timeout_seconds: int = Field(default=20, alias="LYRICS_REFINER_TIMEOUT_SECONDS")
    ...
    lyrics_refiner_temperature: float = Field(default=0.7, alias="LYRICS_REFINER_TEMPERATURE")
